...
#+begin_src emacs-lisp
  (defun my--denote-working-projects-org-table-row (project-filename)
    ...
    (let ((denote-link (denote-link--format-link project-filename
...
[2023-10-20 Fri]
- Create function to open a random denote note

==============================

[2023-10-23 Mon]
- Create function to show working projects in a table, so taht the review of those projects can be made clear if they had any progress.
