...
#+begin_src emacs-lisp
  ...
  (if (not (eq system-type 'windows-nt))
    ...
    (my-defvar my/config-dropbox-folder
               (concat "C:" (replace-regexp-in-string "\\\\" "/" (substitute-in-file-name  "$HOMEPATH/Dropbox/") t t))
               "Path to Dropbox Folder"))
  ...
  (my-defvar my/config-life-folder
  	   (concat my/config-notes-folder "05_LIFE_LOG/")
  	   "Path to Life Log Folder")
...
#+begin_src emacs-lisp
  ...
  (my-defvar my/notes-dates-filename
             (concat my/config-life-folder "20230630T155534--datas-importantes.org")
             "Personal Organization Important Dates Filename")

  (my-defvar my/notes-routine-filename
             (concat my/config-life-folder "20230630T185646--rotina__organization.org")
             "Personal Organization Routine Filename")

  (my-defvar my/notes-week-plans-filename
             (concat my/config-life-folder "20230630T175849--planejamento-semanal__review.org")
             "Personal Organization Weekly Plans Filename")

  (my-defvar my/notes-diary-filename
             (concat my/config-life-folder "diary")
             "Personal Organization Diary Filename")

  (my-defvar my/notes-gtd-inbox-filename
             (concat my/config-life-folder "20230630T164926--gtd-inbox__gtd.org")
             "Personal Organization Get Things Done Inbox Filename")

  (my-defvar my/notes-dashboard-filename
             (concat my/config-life-folder "20260608T204759--main-dashboard.org")
             "Personal Organization Main Dashboard Filename")
...
#+BEGIN_SRC emacs-lisp
  ...
  (my-defvar my/bookmark-file
             (concat my/config-emacs.d-folder "emacsBookmark.el")
...
** Show Directory and Filename on Frame Title
:PROPERTIES:
:Created:  2026-06-06
:END:

https://emacs.stackexchange.com/questions/46013/show-file-names-with-the-full-path-in-the-frame-title
