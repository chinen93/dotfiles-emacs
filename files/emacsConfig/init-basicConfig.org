...
Example of `delete-selection-mode` inactive. [] is the marked region and () is the current point:
#+BEGIN_SRC text
...
Example of `delete-selection-mode` active. [] is the marked region and () is the current point:
#+BEGIN_SRC text
  Lorem ipsum dolor sit amet, [consectetur adipiscing elit()], sed do eiusmod tempor.
