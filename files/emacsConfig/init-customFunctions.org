...
#+BEGIN_SRC emacs-lisp
  ...
  (my-menu-add-doc "Open another [E]macs")


  (defun insertTeste ()
    (interactive)
    (insert "Teste"))
  (define-key start-menu-mode-map (kbd "T") (my-macro-call-command #'insertTeste t))
  (my-menu-add-doc "[T]este")
#+END_SRC
