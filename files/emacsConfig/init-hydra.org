...
#+BEGIN_SRC emacs-lisp
  ...
  (defhydra hydra-launcher (:color amaranth :hint nil)
    "
     ^Favorites^     ^Menus^         ^Functions^        
    -^---------^-----^-----^---------^---------^--------^-^--------------------
     _b_: iBuffer    _D_: Denote     _V_: Bookmark Set  _t_: Truncate Lines
     _v_: Bookmarks  _Y_: YASnippets _c_: Capture       
     _g_: Magit      ^ ^             _w_: Whitespace    
     _m_: Agenda     ^ ^             _d_: Denote        
     ^ ^             _A_ All Hydra   _n_: Elgrep Notes  
    ...
    ("t" toggle-truncate-lines :color blue)
...
#+begin_src emacs-lisp
  ...
  (defhydra hydra-all (:color amaranth :hint nil)
    "
     ^All Hydra Menus^
    -^-^----------------------^-^-----------------------------------
     _1_: Narrow/Widen        _q_: Denote
     _2_: Zoom                _w_: Bookmark
     _3_: Smerge              _e_: Personal Directories
     _4_: Help                _r_: My Functions
     _5_: Custom Functions    _t_: Flycheck
     _6_: Yasnippet           ^ ^
     _7_: Macro               ^ ^
     _8_: Rectangle           ^ ^
     _9_: Math                ^ ^
     _0_: Projectile          ^ ^
    "
    ("1" hydra-narrow-widen/body :color blue)
    ("2" hydra-zoom/body :color blue)
    ("3" hydra-smerge-mode/body :color blue)
    ("4" hydra-help/body :color blue)
    ("5" hydra-functions/body :color blue)
    ("6" hydra-yasnippet/body :color blue)
    ("7" hydra-macro/body :color blue)
    ("8" hydra-rectangle/body :color blue)
    ("9" hydra-math/body :color blue)
    ("0" hydra-projectile/body :color blue)
    ("q" hydra-denote/body :color blue)
    ("w" hydra-bookmark/body :color blue)
    ("e" hydra-personal-files/body :color blue)
    ("r" hydra-my-functions/body :color blue)
    ("t" hydra-flycheck/body :color blue)
...
#+begin_src emacs-lisp
  ...
  (defhydra hydra-denote (:color blue :hint nil)
    "
      ...
      _L_: Add Links       _o_: Open or Create Note
