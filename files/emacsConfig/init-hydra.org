...
#+begin_src emacs-lisp
  ...
  (defhydra hydra-denote (:color blue :hint nil)
    "
       ...
       ^Links^            ^Projects^                   ^Functions^
      ^-^----------------^-^--------------------------^-^-----------
      _l_: Link          _w_: Links Working Projects  _p_: Elgrep ID on Notes
      _L_: Add Links     _m_: Links Maybe Projects    _P_: Projects Progress
      _r_: Rename        _t_: Toogle Maybe/Working    _R_: Random Note
