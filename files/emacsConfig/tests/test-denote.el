...
(defvar my-test/denote-identifier-invalid
  (concat "#+title:      Test \n"
          "#+identifier-invalid: 20240411T18")
  "Denote information for test purposes")
...
(ert-deftest my-test--denote-get-description--valid ()
  ...
  (my-with-test-org-file my-test/denote-identifier
...
(ert-deftest my-test--denote-get-identifier--valid ()
  ...
  (my-with-test-org-buffer my-test/denote-identifier
    (should-equal (my--denote-get-identifier)
