...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list
   ...
   '("m" "Main Agenda"
     (
      (tags ":organization:todo_daily:"
            ((org-agenda-overriding-header "Atividades do Dia")
             (org-agenda-files `(,my/notes-routine-filename))))
      (todo ""
            ((org-agenda-overriding-header "\nPlans / Projects / Tasks\n")
             (org-agenda-files `(,my/notes-dashboard-filename))))
      (tags-todo "gtd"
            ((org-agenda-overriding-header "\nCaptures\n")
