...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Start org files with hidden headlines, However ignore this values when Org
  ;; opens agenda files for the first time
...
#+BEGIN_SRC emacs-lisp
  (add-to-list
   ...
   '("g" "Get Things Done"
     ((todo ""
            ((org-agenda-overriding-header "\nPlano Desenvolvimento Pessoal\n")
             (org-agenda-files
              `(,(concat my/dropbox-folder "Notes/PlanoDesenvolvimentoPessoal.org")))))
      (agenda ""
              ((org-agenda-overriding-header "\nAgenda\n")
               (org-agenda-span 4)
               (org-agenda-start-day "-1d")))
      (todo ""
            ((org-agenda-overriding-header "\nDaily\n")
             (org-agenda-files
              `(,(concat my/dropbox-folder "Daily.org")))))
      (todo "TODAY"
            ((org-agenda-overriding-header "\nToday\n")
             (org-agenda-files
              `(,(concat my/dropbox-folder "Notes/Projetos.org")))))
